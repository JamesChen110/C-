...
namespace Demo
{
	class tesseractOCR
	{
...

		{
			...
			var testFiles = Directory.EnumerateFiles(solutionDirectory + @"\验证码");
			//var testFiles = Directory.EnumerateFiles(@"C: \Users\Jessie\Desktop\James Chen\C#\验证码");
		...
		private static string ParseText(string tesseractPath, byte[] imageFile, params string[] lang)
		{
			...
			//var tempOutputFile = @"C:\Users\Jessie\Desktop\James Chen\C#\result" + Guid.NewGuid();
			//var tempOutputFile = Path.Combine(@"C:\Users\Jessie\Desktop\James Chen\C#\result" , Guid.NewGuid().ToString());
